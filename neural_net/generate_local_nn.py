# Based on code by Max Woolf - https://minimaxir.com/2018/05/text-neural-networks/
# Code runs very slowly locally: Google Collaboratory was used instead due to it's powerful GPU. 
...
file_name = "model/data_large_no_time.txt"
